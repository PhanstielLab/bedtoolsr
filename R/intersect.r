...
#' 
intersect <- function(a, b, header = NULL, names = NULL, nonamecheck = NULL, wao = NULL, loj = NULL, split = NULL, sortout = NULL, wb = NULL, wa = NULL, F = NULL, wo = NULL, filenames = NULL, S = NULL, sorted = NULL, c = NULL, e = NULL, g = NULL, f = NULL, ubam = NULL, bed = NULL, s = NULL, r = NULL, u = NULL, v = NULL, iobuf = NULL, nobuf = NULL)
{ 
	...
	cmd = paste0(bedtools.path, "bedtools intersect ", options, " -a ", a, " -b ", b, " > ", tempfile) 
	system(cmd) 
