...
#' 
map <- function(a, b, c = NULL, o = NULL, delim = NULL, prec = NULL, s = NULL, S = NULL, f = NULL, F = NULL, r = NULL, e = NULL, split = NULL, g = NULL, nonamecheck = NULL, bed = NULL, header = NULL, nobuf = NULL, iobuf = NULL)
{ 
	...
	cmd = paste("/Users/mayurapatwardhan/Downloads/bedtools271/bin/bedtools map ", options, " -a ", a, " -b ", b, " > ", tempfile) 
	system(cmd) 
