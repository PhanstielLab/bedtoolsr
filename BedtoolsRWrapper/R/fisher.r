...
#' 
fisher <- function(a, b, g, m = NULL, s = NULL, S = NULL, f = NULL, F = NULL, r = NULL, e = NULL, split = NULL, g = NULL, nonamecheck = NULL, bed = NULL, header = NULL, nobuf = NULL, iobuf = NULL)
{ 
	options = "" 
	if (is.null(m) == FALSE) 
 	{ 
	...
	cmd = paste("bedtools fisher ", options, " -a " ,a, " -b ", b, " > ", tempfile) 
	system(cmd) 
